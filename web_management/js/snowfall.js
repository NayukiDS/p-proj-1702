...
var snowFall = (function(){
    function jSnow(){
        ...
        var defaults = {
            ...
            // snowflake
            flake = function(_el, _size, _speed, _spin) {
                // Flake properties
                ...
                this.update = function() {
                    ...
                    this.r = (this.r + this.spin) % 360;

                    transform(this.element, 'translateY(' + this.y + 'px) translateX(' + this.x + 'px) rotate(' + this.r + 'deg)');
        ...
        return {
            snow: function(_element, _options) {
                ...
                for (i = 0; i < defaults.flakeCount; i += 1) {
                    flakes.push(new flake(element, random((defaults.minSize * 100), (defaults.maxSize * 100)) / 100, random(defaults.minSpeed, defaults.maxSpeed), random(defaults.spinMin, defaults.spinMax)));
                }
                // start the snow
                animateSnow();
            },
